...
import { sysVariablePage, deleteById } from '@/services/pages/settinsSysVariable';
...
const ContractManage = (props: any) => {
  ...
  const getList = async (params: any): Promise<any> => {
    ...
    const res = await sysVariablePage(postData);
  ...
  const columns: ProColumns<TableListItem>[] = [
    ...
    },
    {
      ...
      valueType: 'option',
      render: (_, row) => [
        <Access key="editButton" accessible={access.canSee('sysVariable_edit')}>
          <a
            onClick={() => {
              addModalOpen(row);
            }}
        ...
        <Access key="delButton" accessible={access.canSee('sysVariable_delete')}>
          <a
            onClick={() => {
              del(row);
            }}
      ...
      >
        <ProTable<TableListItem>
          ...
          toolBarRender={() => [
            <>
              <Space>
                <Access key="addButton" accessible={access.canSee('sysVariable_add')}>
                  <Button
                    onClick={() => {
                      addModalOpen();
                    }}
