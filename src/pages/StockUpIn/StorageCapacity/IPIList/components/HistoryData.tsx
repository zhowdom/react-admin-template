    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          render: (_: any, record: any) => {
            return (
              <span className={record.standard_stock_max_used == 0 ? 'isGrayTxt' : ''}>{record.standard_stock_max_used}</span>
            )
          }
        },
        {
          ...
          render: (_: any, record: any) => {
            return (
              <span className={record.standard_stock_used == 0 ? 'isGrayTxt' : ''}>{record.standard_stock_used}</span>
            )
          }
        },
        {
          ...
          render: (_: any, record: any) => {
            return (
              <span className={record.standard_stock_max_used - record.standard_stock_used == 0 ? 'isGrayTxt' : ''}>{record.standard_stock_max_used - record.standard_stock_used}</span>
            )
          }
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          render: (_: any, record: any) => {
            return (
              <span className={record.big_stock_max_used == 0 ? 'isGrayTxt' : ''}>{record.big_stock_max_used}</span>
            )
          }
        },
        {
          ...
          render: (_: any, record: any) => {
            return (
              <span className={record.big_stock_used == 0 ? 'isGrayTxt' : ''}>{record.big_stock_used}</span>
            )
          }
        },
        {
          ...
          render: (_: any, record: any) => {
            return (
              <span className={record.big_stock_max_used - record.big_stock_used == 0 ? 'isGrayTxt' : ''}>{record.big_stock_max_used - record.big_stock_used}</span>
            )
          }
        },
      ],
